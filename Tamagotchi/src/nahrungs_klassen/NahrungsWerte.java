...
public interface NahrungsWerte {
	...
	public static final int COLA_TTU = 200;
	...
	public static final int MILCH_TTU = 240;
	
	public static final int SALZWASSER_T = -20;
	public static final int SALZWASSER_H = -5;
	public static final int SALZWASSER_TTU = 5;
